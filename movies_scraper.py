...
url_list = {}
api_key = "beafe1d8b68189557b001703953ff0a9c30b6429"
...
def get_movie(query):
    ...
    if movie_page_link:
        ...
        final_links = {}
        for i in links:
            url = f"https://shortnerfly.com/api?api=beafe1d8b68189557b001703953ff0a9c30b6429&url=yourdestinationlink.com&alias=CustomAlias"
